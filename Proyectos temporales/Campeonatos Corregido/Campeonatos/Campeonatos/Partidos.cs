...
//Inserción base de datos
        ...
        private void consultar_calendario()
        {
            ...
            int medio = (total / 2)+1;
            string query = "select d.idequipo,e.nombre as 'nombre', d.goles as 'goles',d.localia from detalle_partido d, equipo e, partido p where e.idequipo=d.idequipo";
