...
namespace equipos
{
    ...
    {
        private DBConnect db = new DBConnect("campeonato.sqlite");
        private int torneo;
        private int equipo;
        ...
        {
            string query = "select idequipo from equipo where idcampeonato = "+torneo;
        ...
        private void jugadores()
        {
            ...
            query = "select idjugador, nombre as 'Nombre', telefono as 'Telefono', direccion as 'Direccion' from jugador where ";
